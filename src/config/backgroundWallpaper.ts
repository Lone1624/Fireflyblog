...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/A1.webp",
			"assets/images/DesktopWallpaper/A2.webp",
			"assets/images/DesktopWallpaper/A3.webp",
			"assets/images/DesktopWallpaper/A4.webp",
			"assets/images/DesktopWallpaper/A5.webp",
			"assets/images/DesktopWallpaper/A6.webp",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/B1.webp",
			"assets/images/MobileWallpaper/B2.webp",
			"assets/images/MobileWallpaper/B3.webp",
			"assets/images/MobileWallpaper/B4.webp",
			"assets/images/MobileWallpaper/B5.webp",
			"assets/images/MobileWallpaper/B6.webp",
		],
		// 背景视频播放地址
